...
const TWILIO_GATHER_TIMEOUT = String(process.env.TWILIO_GATHER_TIMEOUT || "10").trim();
const TWILIO_GATHER_SPEECH_TIMEOUT = String(process.env.TWILIO_GATHER_SPEECH_TIMEOUT || "3").trim();
const TWILIO_SPEECH_MODEL = String(process.env.TWILIO_SPEECH_MODEL || "phone_call").trim();
const TWILIO_ENHANCED_SPEECH = String(process.env.TWILIO_ENHANCED_SPEECH || "true").trim().toLowerCase() === "true";
